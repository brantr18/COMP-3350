; Program Description: This program adds values taken from an array.
; Project 2
; Author: Brantley Robertson
; Creation Date: 2/7/2022
; Revisions: 
;	Date: 2/9/2022		Modified by: Brantley Robertson
;	Date: 2/10/2022		Modified by: Brantley Robertson
